 ...
 * |--------+------+------+------+-------+------| C-   |           |C-Left|------+-------+------+------+------+---------|
 * | LShift |   Z  |   X  |   C  |   V   |   B  | Right|           |      |   N  |   M   |   ,  |   .  |   /  |  `      |
 * `--------+------+------+------+-------+-------------'           `-------------+-------+------+------+------+---------'
 *   |LGui+X|LGUI+C|LGUI+V| LAlt |LG/Eisu|                                       |RG/Kana| Left |  Up  | Down | Right |
 *   `-----------------------------------'                                       `------------------------------------'
 *                                     ,---------------.           ,---------------.
 *                                     | Quiver|LGuiSpc|           |  Up  |  Right |
 *                              ,------|-------|-------|           |------+--------+--------.
 *                              |      |       | Home  |           | Down |        |        |
 *                              |Ctrl/ |TapL1/ |-------|           |------|BackSpc |RShift/ |
 *                              |Space |Tab    | End   |           | Left |        |Enter   |
 *                              `----------------------'           `----------------------'
 */
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_LSFT,      KC_Z,    KC_X,   KC_C,   KC_V,   KC_B,   LCTL(KC_RGHT),
        LGUI(KC_X), LGUI(KC_C), LGUI(KC_V),KC_LALT,GUI_T(KC_LANG2),
                                                      LCTL(LGUI(KC_M)), LGUI(KC_SPC),
                                                                            KC_HOME,
        ...
        RCTL(KC_LEFT),KC_N,           KC_M,   KC_COMM,KC_DOT, KC_SLSH,KC_GRV,
                      GUI_T(KC_LANG1),KC_LEFT,KC_UP,  KC_DOWN, KC_RGHT,
        KC_UP, KC_RGHT,
        KC_DOWN,
        KC_LEFT,     KC_BSPC,SFT_T(KC_ENT)
    ),
